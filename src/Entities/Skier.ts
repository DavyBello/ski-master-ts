...
/**
 * Sequences of images that comprise the animations for the jumping state of the skier.
 */
...
export class Skier extends AnimatedEntity {
    ...
    /**
     * Change the skier back to the skiing state, after jumping
     */
    landFromJump() {
        if (this.isDead()) {
            return;
